...
export default function DashboardPage(props: {
  preloadedGreedting: Preloaded<typeof api.workflows.myGreeting>;
  preloadedRecent: Preloaded<typeof api.episodes.myRecentEpisodes>;
}) {
  const greeting = usePreloadedQuery(props.preloadedGreedting);
  const recent = usePreloadedQuery(props.preloadedRecent);
